				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  ...
						  <div class="tab-pane" id="pic-2"><img src="${image}/${productData.productId}.jpg"  alt="${productData.productname}" /></div>
						  <div class="tab-pane" id="pic-3"><img src="${image}/${productData.productId}.jpg"  alt="${productData.productname}" /></div>
					</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  ...
						  <li><a data-target="#pic-2" data-toggle="tab"><img src="${image}/${productData.productId}.jpg"  alt="${productData.productname}" /></a></li>
						  <li><a data-target="#pic-3" data-toggle="tab"><img src="${image}/${productData.productId}.jpg"  alt="${productData.productname}" /></a></li>
					</ul>
					...
					<div class="details col-md-6">
						...
						<p class="product-description">${productData.productdescription}</p>
